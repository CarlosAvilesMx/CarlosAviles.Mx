...
define('SECRET_SALT','.LzSPTr9CstHmX-TKRZO7ZYnVDIfNw3a');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','hola@carlosaviles.mx');
...
define('DBNAME','aviles_help');
define('DBUSER','aviles_help');
define('DBPASS','Nekroman1.');
